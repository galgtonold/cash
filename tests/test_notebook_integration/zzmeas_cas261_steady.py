...
def test_0_1ms(nb_runner):
    print("ST_0_1 " + json.dumps(_pair(nb_runner, 0.1)))


def test_1ms(nb_runner):
    print("ST_1 " + json.dumps(_pair(nb_runner, 1)))


def test_2_5ms(nb_runner):
    print("ST_2_5 " + json.dumps(_pair(nb_runner, 2.5)))
