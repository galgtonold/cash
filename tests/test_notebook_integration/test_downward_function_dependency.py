"""A call site does not depend on functions defined BELOW it.
...
@pytest.mark.xfail(
    strict=True,
    reason=(
        "OPEN, the remaining half of downward function dependencies. The call site's KEY now carries the "
