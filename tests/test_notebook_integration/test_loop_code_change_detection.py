...
class TestLoopCodeChangeDetection:
    ...
    def test_change_loop_body_intermediate_cell_recomputes(self, nb_runner):
        ...
        assert "100.0000" in output6_mod, f"Loop code change not propagated to cell 6! Got: {output6_mod}"
    ...
    def test_loop_change_not_rerun_directly(self, nb_runner):
        ...
        assert "value=200.0" in output5_mod, f"Loop code change (iterations) not detected! Got: {output5_mod}"
