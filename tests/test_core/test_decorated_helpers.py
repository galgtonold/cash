...
CASES = [
    ...
    (
        ...
        def h(x):
            return x + 1
    """,
        ("helpers.py", "@scale_nowraps(10)", "@scale_nowraps(100)"),
        JOB,
        None,
    ),
    (
    ...
    (
        ...
        def h(x):
            return x / 3
    """,
        ("helpers.py", "otypes=[float]", "otypes=[int]"),
        JOB,
        "numpy",
    ),
    (
