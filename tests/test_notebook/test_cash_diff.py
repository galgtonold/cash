...
class TestCashDiff:
    ...
    def test_diff_empty_vs_empty(self, magics_fixture, capsys, tmp_path):
        ...
        cache_file.write_text(json.dumps({"lineage": {}, "cell_codes": {}, "entries": {}}))
    ...
    def test_diff_current_has_more(self, magics_fixture, capsys, tmp_path):
        ...
        magics, shell, backend = magics_fixture
        magics.tracking_state.variable_lineage["x"] = "hash_x"
        magics.tracking_state.variable_lineage["y"] = "hash_y"

        cache_file = tmp_path / "other.cache"
        cache_file.write_text(json.dumps({"lineage": {"x": "hash_x"}, "cell_codes": {}}))
    ...
    def test_diff_other_has_more(self, magics_fixture, capsys, tmp_path):
        ...
        cache_file = tmp_path / "other.cache"
        cache_file.write_text(json.dumps({"lineage": {"x": "hash_x", "y": "hash_y", "z": "hash_z"}, "cell_codes": {}}))
    ...
    def test_diff_changed_lineage(self, magics_fixture, capsys, tmp_path):
        ...
        magics, shell, backend = magics_fixture
        magics.tracking_state.variable_lineage["x"] = "hash_x_v2"  # Changed
        magics.tracking_state.variable_lineage["y"] = "hash_y"  # Same

        cache_file = tmp_path / "other.cache"
        cache_file.write_text(json.dumps({"lineage": {"x": "hash_x_v1", "y": "hash_y"}, "cell_codes": {}}))
    ...
    def test_diff_with_vars_flag(self, magics_fixture, capsys, tmp_path):
        ...
        magics, shell, backend = magics_fixture
        magics.tracking_state.variable_lineage["alpha"] = "hash_a"
        magics.tracking_state.variable_lineage["beta"] = "hash_b_v2"

        cache_file = tmp_path / "other.cache"
        cache_file.write_text(json.dumps({"lineage": {"beta": "hash_b_v1", "gamma": "hash_g"}, "cell_codes": {}}))
    ...
    def test_diff_all_identical(self, magics_fixture, capsys, tmp_path):
        ...
        magics, shell, backend = magics_fixture
        magics.tracking_state.variable_lineage["x"] = "h1"
        magics.tracking_state.variable_lineage["y"] = "h2"

        cache_file = tmp_path / "other.cache"
        cache_file.write_text(json.dumps({"lineage": {"x": "h1", "y": "h2"}, "cell_codes": {}}))
    ...
    def test_diff_pickle_format(self, magics_fixture, capsys, tmp_path):
        ...
        with open(cache_file, "wb") as f:
            pickle.dump({"version": 1, "lineage": {"x": "hash_x", "z": "hash_z"}, "cell_codes": {}, "entries": []}, f)
...
class TestCashExportJson:
    ...
    def test_export_json_basic(self, magics_fixture, capsys, tmp_path):
        ...
        magics.tracking_state.variable_lineage["x"] = "hash_x"
        magics.tracking_state.variable_lineage["y"] = "hash_y"
        magics.tracking_state.executed_cell_codes["x"] = "x = 1"
        magics.tracking_state.executed_cell_codes["y"] = "y = 2"
    ...
    def test_export_json_with_vars(self, magics_fixture, capsys, tmp_path):
        ...
        magics.tracking_state.variable_lineage["x"] = "hash_x"
        magics.tracking_state.variable_lineage["y"] = "hash_y"
        magics.tracking_state.variable_lineage["z"] = "hash_z"
        magics.tracking_state.executed_cell_codes["x"] = "x = 1"
    ...
    def test_export_json_then_diff(self, magics_fixture, capsys, tmp_path):
        ...
        magics, shell, backend = magics_fixture
        magics.tracking_state.variable_lineage["a"] = "h1"
        magics.tracking_state.variable_lineage["b"] = "h2"
        ...
        magics.tracking_state.variable_lineage["b"] = "h2_changed"
        magics.tracking_state.variable_lineage["c"] = "h3"
