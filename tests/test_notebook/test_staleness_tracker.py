...
def test_a_cell_magic_line_is_compared_like_any_other_line(tmp_path):
    """The `%cash_on` hook hands cash the RAW cell, cell-magic line and all,
    and the file holds the same text: an untouched `%%time` cell must match,
    and an edit under the magic line must still be caught."""
