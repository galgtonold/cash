...
from benchmarks.fit_cost_model import FitRow, fit_all, fit_linear, render_python_constants
...
def test_render_python_constants_produces_valid_dict_literal():
    fits = [
        FitRow(family="x", backend_kind="ram", operation="serialize", a=0.001, b=2e-9, r_squared=0.99, n_points=4),
        FitRow(family="x", backend_kind="ram", operation="deserialize", a=0.0005, b=1e-9, r_squared=0.95, n_points=4),
    ]
