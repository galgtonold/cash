...
<!-- claim: cash/backends/tiered_backend.py:TieredBackend.__init__ @aa78bb3d, cash/backends/tiered_backend.py:TieredBackend._default_promotion_policy @7c228c64, cash/config.py:CashConfig.smart_persistence == True -->
