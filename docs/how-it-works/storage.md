...
??? question "How does cache metadata stay typed without locking the backends in?"
    <!-- claim: cash/backends/_base.py:CacheMetadata @5cfa4c6e, cash/notebook/statement/_metadata.py:StatementCacheMetadata @59339cb6 broad="the frozen-dataclass-in, dict-on-the-wire contract is a property of both classes" -->
