...
<!-- claim: cash/notebook/file_dep_snapshot.py:file_dep_is_fresh @8b351a2f, cash/notebook/function_tracker.py:FunctionTracker @1a485c19 broad="the trust thesis names two whole mechanisms - file freshness and function-source tracking - not one function each" -->
