...
<!-- claim: cash/notebook/file_dep_snapshot.py:file_dep_is_fresh @ab9621f0, cash/notebook/function_tracker.py:FunctionTracker @2b63e97e broad="the trust thesis names two whole mechanisms - file freshness and function-source tracking - not one function each" -->
...
<!-- claim: cash/notebook/ipython/cell_executor.py:CellExecutor._execute_cell_statements @d08226b9, cash/core.py:Cash.cache @5f39ebf4 -->
