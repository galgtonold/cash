...
**<!-- docnum:tests_total -->~9,800<!-- /docnum --> tests** across three suites,
spread over <!-- docnum:test_files -->~1,320<!-- /docnum --> files:

| Suite | Size | What it covers |
|---|---|---|
| Unit | <!-- docnum:tests_unit -->~5,200<!-- /docnum --> | The engine: cache keys, lineage, hashing, backends, invalidation |
