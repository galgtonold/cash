...
**<!-- docnum:tests_total -->~9,600<!-- /docnum --> tests** across three suites,
spread over <!-- docnum:test_files -->~1,300<!-- /docnum --> files:

| Suite | Size | What it covers |
|---|---|---|
| Unit | <!-- docnum:tests_unit -->~5,030<!-- /docnum --> | The engine: cache keys, lineage, hashing, backends, invalidation |
...
**Prose is pinned to source.** Around **<!-- docnum:claims -->~350<!-- /docnum --> claims** across
