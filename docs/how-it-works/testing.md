...
**<!-- docnum:tests_total -->~9,900<!-- /docnum --> tests** across three suites,
spread over <!-- docnum:test_files -->~1,330<!-- /docnum --> files:

| Suite | Size | What it covers |
|---|---|---|
| Unit | <!-- docnum:tests_unit -->~5,230<!-- /docnum --> | The engine: cache keys, lineage, hashing, backends, invalidation |
| Notebook integration | <!-- docnum:tests_integration -->~4,280<!-- /docnum --> | Real kernels executing real notebooks, cell by cell |
