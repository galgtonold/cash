...
**<!-- docnum:tests_total -->~10,250<!-- /docnum --> tests** across three suites,
spread over <!-- docnum:test_files -->~1,410<!-- /docnum --> files:

| Suite | Size | What it covers |
|---|---|---|
| Unit | <!-- docnum:tests_unit -->~5,470<!-- /docnum --> | The engine: cache keys, lineage, hashing, backends, invalidation |
| Notebook integration | <!-- docnum:tests_integration -->~4,410<!-- /docnum --> | Real kernels executing real notebooks, cell by cell |
