...
**<!-- docnum:tests_total -->~9,250<!-- /docnum --> tests** across three suites,
spread over <!-- docnum:test_files -->~1,260<!-- /docnum --> files:

| Suite | Size | What it covers |
|---|---|---|
| Unit | <!-- docnum:tests_unit -->~4,670<!-- /docnum --> | The engine: cache keys, lineage, hashing, backends, invalidation |
