...
**<!-- docnum:tests_total -->~10,300<!-- /docnum --> tests** across three suites,
spread over <!-- docnum:test_files -->~1,420<!-- /docnum --> files:

| Suite | Size | What it covers |
|---|---|---|
| Unit | <!-- docnum:tests_unit -->~5,520<!-- /docnum --> | The engine: cache keys, lineage, hashing, backends, invalidation |
