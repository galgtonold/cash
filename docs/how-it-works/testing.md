...
**<!-- docnum:tests_total -->~8,900<!-- /docnum --> tests** across three suites,
spread over <!-- docnum:test_files -->~1,220<!-- /docnum --> files:

| Suite | Size | What it covers |
|---|---|---|
| Unit | <!-- docnum:tests_unit -->~4,410<!-- /docnum --> | The engine: cache keys, lineage, hashing, backends, invalidation |
