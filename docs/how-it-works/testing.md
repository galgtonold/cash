...
**<!-- docnum:tests_total -->~10,800<!-- /docnum --> tests** in
<!-- docnum:test_files -->~1,070<!-- /docnum --> files:

| Suite | Size | What it covers |
|---|---|---|
| Unit | <!-- docnum:tests_unit -->~6,350<!-- /docnum --> | keys, lineage, hashing, backends, the decorator, the notebook engine with a real IPython shell |
| Notebook integration | <!-- docnum:tests_integration -->~3,970<!-- /docnum --> | real kernels running real notebooks, one folder per feature |
...
- **Claims are pinned to the code.** About
  <!-- docnum:claims -->~300<!-- /docnum --> statements about behaviour carry an
