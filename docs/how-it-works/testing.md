...
**<!-- docnum:tests_total -->~10,800<!-- /docnum --> tests** across three suites,
spread over <!-- docnum:test_files -->~1,500<!-- /docnum --> files:

| Suite | Size | What it covers |
|---|---|---|
| Unit | <!-- docnum:tests_unit -->~5,880<!-- /docnum --> | The engine: cache keys, lineage, hashing, backends, invalidation |
...
**Prose is pinned to source.** Around **<!-- docnum:claims -->~410<!-- /docnum --> claims** across
