...
**<!-- docnum:tests_total -->~10,200<!-- /docnum --> tests** across three suites,
spread over <!-- docnum:test_files -->~1,400<!-- /docnum --> files:

| Suite | Size | What it covers |
|---|---|---|
| Unit | <!-- docnum:tests_unit -->~5,430<!-- /docnum --> | The engine: cache keys, lineage, hashing, backends, invalidation |
| Notebook integration | <!-- docnum:tests_integration -->~4,400<!-- /docnum --> | Real kernels executing real notebooks, cell by cell |
