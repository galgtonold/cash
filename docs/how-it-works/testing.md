...
**<!-- docnum:tests_total -->~10,650<!-- /docnum --> tests** across three suites,
spread over <!-- docnum:test_files -->~1,480<!-- /docnum --> files:

| Suite | Size | What it covers |
|---|---|---|
| Unit | <!-- docnum:tests_unit -->~5,780<!-- /docnum --> | The engine: cache keys, lineage, hashing, backends, invalidation |
| Notebook integration | <!-- docnum:tests_integration -->~4,490<!-- /docnum --> | Real kernels executing real notebooks, cell by cell |
