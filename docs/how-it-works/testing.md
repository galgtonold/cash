...
**<!-- docnum:tests_total -->~10,850<!-- /docnum --> tests** in
<!-- docnum:test_files -->~1,070<!-- /docnum --> files:

| Suite | Size | What it covers |
|---|---|---|
| Unit | <!-- docnum:tests_unit -->~6,370<!-- /docnum --> | keys, lineage, hashing, backends, the decorator, the notebook engine with a real IPython shell |
...
- **Claims are pinned to the code.** About
  <!-- docnum:claims -->~310<!-- /docnum --> statements about behaviour carry an
