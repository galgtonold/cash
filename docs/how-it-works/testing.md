...
<!-- docnum:version -->0.9.3<!-- /docnum -->. The mechanisms matter more than the counts, and they
...
|---|---|---|
| Unit | <!-- docnum:tests_unit -->~4,480<!-- /docnum --> | The engine: cache keys, lineage, hashing, backends, invalidation |
