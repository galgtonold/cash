...
**<!-- docnum:tests_total -->~9,300<!-- /docnum --> tests** across three suites,
spread over <!-- docnum:test_files -->~1,270<!-- /docnum --> files:

| Suite | Size | What it covers |
|---|---|---|
| Unit | <!-- docnum:tests_unit -->~4,750<!-- /docnum --> | The engine: cache keys, lineage, hashing, backends, invalidation |
