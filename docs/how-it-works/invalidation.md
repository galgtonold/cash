...
<!-- claim: cash/notebook/upstream/checker.py:UpstreamChecker @89e243b0, cash/notebook/upstream/simulator.py:NotebookSimulator @6555f1b1, cash/notebook/server_discovery.py:_read_notebook_code_cells @f6b1396e broad="the simulation story is the two orchestrating classes, not one method" -->
...
<!-- claim: cash/notebook/cacheability.py @158dff60 broad="the three-tier mutation classification spans the module, not one function" -->
