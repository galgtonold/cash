...
<!-- claim: cash/notebook/upstream/checker.py:UpstreamChecker @ec254368, cash/notebook/upstream/simulator.py:NotebookSimulator @b4162a28, cash/notebook/server_discovery.py:_read_notebook_code_cells @f6b1396e broad="the simulation story is the two orchestrating classes, not one method" -->
...
<!-- claim: cash/notebook/cacheability.py @b837cacc broad="the three-tier mutation classification spans the module, not one function" -->
