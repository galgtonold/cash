...
<!-- claim: cash/notebook/upstream/checker.py:UpstreamChecker @6432936e, cash/notebook/upstream/simulator.py:NotebookSimulator @a7f20c2a, cash/notebook/server_discovery.py:NotebookCellReaders.read @d0b4a970 broad="the simulation story is the two orchestrating classes, not one method" -->
...
<!-- claim: cash/analysis/mutations.py @7a0becbc broad="the three-tier mutation classification spans the module, not one function", cash/analysis/mutation_effects.py:classify_receivers @704f9e6f -->
