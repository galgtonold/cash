...
<!-- claim: cash/notebook/upstream/checker.py:UpstreamChecker @38bcb296, cash/notebook/upstream/simulator.py:NotebookSimulator @225113c8, cash/notebook/server_discovery.py:_read_notebook_code_cells @f6b1396e broad="the simulation story is the two orchestrating classes, not one method" -->
...
<!-- claim: cash/notebook/cacheability.py @ea76a52b broad="the three-tier mutation classification spans the module, not one function" -->
