...
<!-- claim: cash/notebook/upstream/checker.py:UpstreamChecker @a1c4051b, cash/notebook/upstream/simulator.py:NotebookSimulator @ca0ad761, cash/notebook/server_discovery.py:_read_notebook_code_cells @f6b1396e broad="the simulation story is the two orchestrating classes, not one method" -->
