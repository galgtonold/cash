...
<!-- claim: cash/decorator/rng.py:RngWatch.replay_parts @f6e21ca2, cash/decorator/rng.py:replay_rng_state @3c1a8bbb -->
...
<!-- claim: cash/exceptions.py:AmbiguousCellError @267a93a2, cash/notebook/upstream/checker.py:UpstreamChecker.check_and_reexecute @057d4768 broad="the claim is about when this exception type exists to be raised at all" -->
...
<!-- claim: cash/decorator/code_identity.py:is_user_code_object @ee3edea9, cash/decorator/code_identity.py:is_user_code_module @8b0f31ab -->
