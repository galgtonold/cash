...
<!-- claim: cash/data_source.py:FileDataSource @a09d1326 broad="the mtime contract is a property of the whole class", cash/remote_source.py:RemoteFileDataSource @e90b5690 broad="the scheme list and validator contract are properties of the whole class" -->
