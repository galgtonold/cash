...
<!-- claim: cash/data_source.py:FileDataSource @4099fc64 broad="the mtime contract is a property of the whole class", cash/remote_source.py:RemoteFileDataSource @919c0871 broad="the scheme list and validator contract are properties of the whole class" -->
