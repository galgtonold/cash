...
<!-- claim: cash/config.py:CashConfig.disable == False, cash/core.py:Cash._wrap_with_stats @d71a74cd -->
```bash
...
<!-- claim: cash/effect_observer.py:_hook_mock_calls @70417b4d, cash/core.py:Cash._store_refusal @3815fd67 -->
