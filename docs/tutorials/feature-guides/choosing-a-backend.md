...
<!-- claim: cash/backends/file_eviction.py:FileEvictor.rebuild_queue @8db54c6b, cash/backends/file_eviction.py:FileEvictor.evict @27bf1fea, cash/backends/rank_index.py:RankIndex.load @29f8b401, cash/backends/file_eviction.py:FileEvictor.record_rank @e5d36a7f, cash/backends/rank_index.py:INDEX_FILENAME == '_rank.log' -->
