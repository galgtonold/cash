...
<!-- claim: cash/core.py:Cash._print_run_summary @f2a46f9f, cash/decorator/reporting.py:CallLog.log @5ea0cb91 -->
...
<!-- claim: cash/decorator/explain.py:CacheExplanation @9f1db6f8 broad="the field list and reason set are a claim about the whole dataclass", cash/decorator/explain.py:Explainer.explain @4c427520 -->
