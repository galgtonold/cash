...
<!-- claim: cash/notebook/statement/file_deps.py:compute_file_hash_component @08702b7b, cash/notebook/file_dep_snapshot.py:file_dep_is_fresh @ab9621f0 -->
<!-- claim: cash/remote_source.py:RemoteFileDataSource @241d9616 broad="the portability claim is a property of the whole source type" -->
