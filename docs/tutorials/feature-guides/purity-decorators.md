...
<!-- claim: cash/effect_observer.py:EffectObserver @fe95f92d broad="the observed-effect contract is the class as a whole", cash/decorator/purity_checks.py:PurityChecksMixin._report_observed_effects @488c45ec -->
...
<!-- claim: cash/purity_analyzer.py:_PurityVisitor._record_call @005403b5 broad="the flag list is a claim about every branch of the call rule", cash/purity_analyzer.py:_PurityVisitor.finalize_taint @a557e11f, cash/purity_analyzer.py:_PurityVisitor._table_is_reachable_from_the_key @f40e5656 -->
