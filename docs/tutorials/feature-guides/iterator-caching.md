...
<!-- claim: cash/decorator/store.py:ResultStore.stream_and_store @e40861ba broad="the loop, the tracker scope and the commit rule are one mechanism", cash/object_hashing.py:estimate_object_size @645bc0a2 -->
...
<!-- claim: cash/core.py:Cash.cache @3b5f1fd0 broad="the defaults are keyword arguments of the decorator itself", cash/decorator/cached_function.py:CHUNK_MAX_ITEMS == 1_000_000, cash/decorator/cached_function.py:CHUNK_MAX_BYTES == 1_000_000_000 -->
Defaults:
...
<!-- claim: cash/decorator/runtime.py:CallRunner._wrap_iterator_hit @bfbd9d6d, cash/decorator/iterators.py:StreamingCachedIterator @8cf26947 broad="the claim is about the whole replay wrapper", cash/decorator/iterators.py:ChunkedCachedIterator @8e258231 broad="the claim is about the whole replay wrapper" -->
...
<!-- claim: cash/decorator/iterators.py:ChunkedCachedIterator.__next__ @64b46718 -->
...
<!-- claim: cash/decorator/runtime.py:CallRunner._chunks_are_intact @62041ef1, cash/decorator/runtime.py:CallRunner.compute_with_lock @b4c5c8c2 -->
...
<!-- claim: cash/decorator/store.py:ResultStore.attach_lineage @15a1c92c -->
