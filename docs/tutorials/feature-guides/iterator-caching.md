...
<!-- claim: cash/decorator/store.py:StoreMixin._stream_and_store @5c2fe2d2 broad="the loop, the tracker scope and the commit rule are one mechanism", cash/object_hashing.py:estimate_object_size @645bc0a2 -->
...
<!-- claim: cash/decorator/runtime.py:RuntimeMixin._chunks_are_intact @fd3a5c46, cash/decorator/runtime.py:RuntimeMixin._compute_with_lock @7c213409 -->
...
<!-- claim: cash/decorator/store.py:StoreMixin._attach_lineage @ff08ebd6 -->
