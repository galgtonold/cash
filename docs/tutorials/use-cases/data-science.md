...
<!-- claim: cash/analysis/mutations.py:MutationVisitor @7c19f318 broad="the subscript-store verdict is one branch of the visitor, read together with the outputs rule", cash/notebook/upstream/checker.py:UpstreamChecker.check_and_reexecute @057d4768 -->
