...
<!-- claim: cash/analysis/cacheability.py:_MutationVisitor @c41cea02 broad="the subscript-store verdict is one branch of the visitor, read together with the outputs rule", cash/notebook/upstream/checker.py:UpstreamChecker.check_and_reexecute @8b25634c -->
