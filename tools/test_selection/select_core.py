...
FEATURES = {
    ...
    "tracking/read_classification": "file_deps",
    "tracking/read_credit": "file_deps",
    "tracking/read_events": "file_deps",
    "tracking/reader_patches": "file_deps",
    "tracking/tracker_context": "file_deps",
