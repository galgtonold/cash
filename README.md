...
A cache is only worth as much as your trust in it, so [**how cash is tested**](https://cash-lib.readthedocs.io/en/latest/how-it-works/testing/) is written down: <!-- docnum:tests_total -->~9,950<!-- /docnum --> tests across <!-- docnum:platforms -->15<!-- /docnum --> platform combinations, documentation whose code is executed and whose prose is pinned to the source that decides it, and a section on what all of that still fails to catch.
