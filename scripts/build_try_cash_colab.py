...
COLAB_SETUP = [
    ...
    "#\n",
    "# TIP: once it's installed, comment out the %pip line below. On a second\n",
    "# 'Run all' it reinstalls cash from GitHub (~20s) every time and becomes the\n",
    "# slowest cell in the notebook — for a demo that's otherwise about avoiding\n",
    "# needless recompute, that's the one thing worth skipping by hand.\n",
